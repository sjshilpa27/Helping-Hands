        ...
        <div class="col-lg-12">
            <form action="registeration.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="txtuid" id="nome" class="form-control" placeholder="Name" name="txtuser" hidden
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nome" class="form-control" placeholder="Date of Birth" name="txtdob">      
                </div>        
                <div class="form-group">
